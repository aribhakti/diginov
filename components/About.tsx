      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            ...
            >
                ...
                <div className="flex gap-4 flex-wrap">
                    <div className="px-6 py-4 bg-slate-50 rounded-2xl border border-slate-100 hover:border-primary-200 transition-colors">
                    ...
                    <div className="px-6 py-4 bg-slate-50 rounded-2xl border border-slate-100 hover:border-secondary-200 transition-colors">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <motion.div 
                ...
                viewport={{ once: true }}
                whileHover={{ y: -5 }}
                className="bg-white border border-slate-100 p-10 rounded-[2.5rem] shadow-xl hover:shadow-2xl transition-all duration-300 relative overflow-hidden group cursor-default"
            >
            ...
            <motion.div 
                ...
                whileHover={{ y: -5 }}
                className="bg-slate-900 border border-slate-800 p-10 rounded-[2.5rem] shadow-xl hover:shadow-2xl transition-all duration-300 relative overflow-hidden group cursor-default"
            >
